...
>) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(3,5,10,0.72)] px-4 py-8 backdrop-blur-[18px]">
      <div className={recycleDialogShellClassName}>
        ...
        <div className="space-y-4 px-5 py-4">
          ...
          <div className={recycleDialogSectionClassName}>
            <div className="flex flex-wrap items-center gap-2">
...
export function CustomerRecycleEntry(props: Readonly<CustomerRecycleEntryProps>) {
  ...
  return (
    <div className="mt-4 space-y-3 border-t border-[var(--color-border-soft)] pt-3.5">
      {state.notice ? (
