...
export function TradeOrderRecycleDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/34 px-4 py-8">
      <div className="w-full max-w-3xl overflow-hidden rounded-xl border border-border bg-[rgba(255,255,255,0.98)] shadow-[0_24px_60px_rgba(18,24,31,0.18)]">
        <div className="flex items-start justify-between gap-4 border-b border-border/60 bg-[var(--color-shell-surface-soft)] px-5 py-4">
          <div className="space-y-2">
            ...
            <div>
              <h3 className="text-[1.02rem] font-semibold text-foreground">移入回收站</h3>
        ...
        <div className="space-y-4 px-5 py-4">
          ...
          {guard.canMoveToRecycleBin ? (
            <>
              ...
              <div className="rounded-xl border border-[rgba(155,106,29,0.18)] bg-[rgba(255,248,238,0.86)] px-4 py-3 text-[13px] leading-6 text-[rgba(92,61,30,0.92)]">
...
function TradeOrderBlockerGroupCard({
  ...
  return (
    <div className="rounded-md border border-border/60 bg-[rgba(249,250,252,0.78)] p-3.5">
      <div className="space-y-1">
        <p className="text-sm font-semibold text-foreground">{group.title}</p>
        <p className="text-[13px] leading-5 text-muted-foreground">{group.description}</p>
      </div>
