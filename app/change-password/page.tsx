...
export default async function ChangePasswordPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 py-12">
      <div className="w-full max-w-4xl rounded-xl border border-[rgba(32,24,19,0.08)] bg-[rgba(251,248,242,0.78)] p-4 shadow-[0_20px_60px_rgba(55,39,21,0.1)] backdrop-blur md:grid md:grid-cols-[1fr_0.95fr] md:gap-8 md:p-8">
        <section className="hidden rounded-xl bg-[linear-gradient(180deg,#261c16_0%,#3a281d_100%)] p-8 text-[var(--color-sidebar-foreground)] md:flex md:flex-col md:justify-between">
          <div>
          ...
          <div className="rounded-3xl border border-white/10 bg-foreground/5 p-5 text-sm leading-7 text-[var(--color-sidebar-muted)]">
            当前账号：
            <br />
